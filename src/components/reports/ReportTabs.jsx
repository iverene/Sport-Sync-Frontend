  ...
  return (
    <div className="flex justify-evenly items-center gap-2 p-2 w-full bg-lightGray rounded-full ">
      ...
      <button
        ...
        className={`flex items-center justify-center w-full gap-2 px-6 py-4 md:py-2 lg:py-2 rounded-full border transition
          ${activeTab === "manual"
      ...
      <button
        ...
        className={`flex items-center justify-center w-full gap-2 px-6 py-2 rounded-full border transition
          ${activeTab === "automated"
